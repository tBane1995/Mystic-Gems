...
public class Button extends ElementGUI {
    ...
    private Tex _normalTexture, _hoverTexture, _pressedTexture;

    public ButtonStates _state;
    float _clickTime;
    public Runnable onclick_func;

    public Button(Tex normalTexture, Tex hoverTexture, Tex pressedTexture, int x, int y, int width, int height) {
        super();
