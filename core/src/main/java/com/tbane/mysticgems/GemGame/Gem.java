...
import com.tbane.mysticgems.GemGame.GemColor;
...
public class Gem {
    ...
    public void drawColor() {
        ...
        switch (effect) {
            ...
            case DestroyAll: {
                GemColor c = new GemColor();
                c = GemColor.rgb((t * 60f) % 360f, 1f, 1f);
                r = c.r;
                g = c.g;
                b = c.b;
                break;
            ...
            case DestroyType: {
                ...
                GemColor c = new GemColor();
                c = GemColor.rgb(0f, 1f, pulse); // hue 0 = red
                r = c.r;
                g = c.g;
                b = c.b;
                break;
            ...
            case BonusPoints: {
                ...
                GemColor c = new GemColor();
                c = GemColor.rgb(45f, 1f, pulse); // 45° = gold
                r = c.r;
                g = c.g;
                b = c.b;
                break;
    ...
    public void drawBubble() {
        ...
        if(bubbleTex != null){
            // draw bubble sprite
            Sprite sprite = new Sprite(bubbleTex.texture);
    ...
    public void drawGem() {
        ...
        // draw the gem
        Tex gemTex = TexturesManager.getTexture(color);
        if(gemTex != null){
            Sprite sprite = new Sprite(gemTex.texture);
            sprite.setSize(size.x, size.y);
            sprite.setOrigin(sprite.getWidth()/2, sprite.getHeight()/2);
            sprite.setCenter(position.x, position.y);   // positioning with centering
            sprite.setRotation(rotation);
