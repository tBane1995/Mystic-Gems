...
public class Highscores extends Layout {
    ...
    public void draw() {
        ...
        // draw a award cup
        Sprite awardCup = new Sprite(TexturesManager.getTexture("tex/awardCup.png").texture);
        ...
        for(int i=0;i<15;i+=1){
            ...
            layout.setText(Font.buttonFont, _names.get(i));
            ...
            layout.setText(Font.buttonFont, value);
            textWidth = layout.width;
