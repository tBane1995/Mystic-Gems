...
public class main extends ApplicationAdapter {
    ...
    public void create() {
        ...
        MyInput input = new MyInput(Renderer.camera);
    ...
    public void render() {
        ...
        if(MyInput.processor.isTouchDown() || MyInput.processor.isTouchUp() || MyInput.processor.isTouchMoved() || MyInput.processor.isBackPressed() || MyInput.processor.isKeyTyped() ){
            ...
            Objects.requireNonNull(LayoutsManager.back()).handleEvents();
        ...
        Objects.requireNonNull(LayoutsManager.back()).update();

        ScreenUtils.clear(0, 0, 0, 0);
        Renderer.begin();
        Objects.requireNonNull(LayoutsManager.back()).draw();
